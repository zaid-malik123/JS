...
class Assistant {
    ...
    constructor(options, config) {
        if (!options.name || options.name.trim() === '') {
            throw new errors_1.PineconeArgumentError('Assistant name is required and cannot be empty.');
        }
        this.config = config;
        const asstDataOperationsProvider = new asstDataOperationsProvider_1.AsstDataOperationsProvider(this.config, options.name, options.host, options.additionalHeaders);
